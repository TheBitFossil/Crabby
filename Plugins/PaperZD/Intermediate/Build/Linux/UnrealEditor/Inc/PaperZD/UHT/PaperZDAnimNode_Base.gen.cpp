...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Games_epic_drive_c_users_tbf_Documents_Unreal_Projects_GDTV_CrustyPirate_Project_Plugins_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_Base_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FPaperZDAnimDataLink::StaticStruct, Z_Construct_UScriptStruct_FPaperZDAnimDataLink_Statics::NewStructOps, TEXT("PaperZDAnimDataLink"), &Z_Registration_Info_UScriptStruct_PaperZDAnimDataLink, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDAnimDataLink), 4293149857U) },
		{ FPaperZDExposedValueHandler::StaticStruct, Z_Construct_UScriptStruct_FPaperZDExposedValueHandler_Statics::NewStructOps, TEXT("PaperZDExposedValueHandler"), &Z_Registration_Info_UScriptStruct_PaperZDExposedValueHandler, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDExposedValueHandler), 535010471U) },
		{ FPaperZDAnimNode_Base::StaticStruct, Z_Construct_UScriptStruct_FPaperZDAnimNode_Base_Statics::NewStructOps, TEXT("PaperZDAnimNode_Base"), &Z_Registration_Info_UScriptStruct_PaperZDAnimNode_Base, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPaperZDAnimNode_Base), 4070887814U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Games_epic_drive_c_users_tbf_Documents_Unreal_Projects_GDTV_CrustyPirate_Project_Plugins_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_Base_h_239731133(TEXT("/Script/PaperZD"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Games_epic_drive_c_users_tbf_Documents_Unreal_Projects_GDTV_CrustyPirate_Project_Plugins_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_Base_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Games_epic_drive_c_users_tbf_Documents_Unreal_Projects_GDTV_CrustyPirate_Project_Plugins_PaperZD_Source_PaperZD_Public_AnimNodes_PaperZDAnimNode_Base_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
